...
async def start(client, message):
    ...
    if len(message.command) != 2:
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('💸 𝗚𝗿𝗼𝘂𝗽 𝗔𝗱𝗱 𝗘𝗮𝗿𝗻𝗶𝗻𝗴', callback_data="shortlink_info"),
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            text = "<b>हे {username} 👋,\n\nआपने वेरिफिकेशन पूरा कर लिया है ✅\n\nअब आप बॉट को 24 घंटे तक इस्तेमाल कर सकते हैं — बिना किसी रुकावट के 🎬🍿\nमज़े लीजिए फुल स्पीड एक्सेस के साथ 🔥</b>"
            if PREMIUM_AND_REFERAL_MODE == True:
                text += "<b>अगर आप बिना किसी वेरिफिकेशन के डायरेक्ट फाइल्स चाहते हैं — तो बॉट का सब्सक्रिप्शन ले लें ☺️\n\n💶 बॉट का सब्सक्रिप्शन प्लान लेने के लिए /plan पर क्लिक करें या नीचे टाइप करें — /plan</b>"           
        ...
        for file in files:
            ...
            if not await db.has_premium_access(message.from_user.id):
                if not await check_verification(client, message.from_user.id) and VERIFY == True:
                    ...
                    text = "<b>हे {username} 👋,\n\nआपने अभी तक वेरिफाई नहीं किया है ⚠️\n\nपहले वेरिफाई करें, तभी आपको फाइल्स मिलेंगी 📥\n\nवेरिफिकेशन के बाद आप बॉट से 24 घंटे तक अनलिमिटेड मूवीज़ डाउनलोड कर सकते हैं 🎬🔥</b>"
                    if PREMIUM_AND_REFERAL_MODE == True:
                        text += "<b>अगर आप बोट का प्रीमियम वर्जन लेते हैं — तो आप बोट से अनलिमिटेड मूवीज़, वेब सीरीज़ और एनीमे डाउनलोड और स्ट्रीम कर सकते हैं 🎬🔥\n\n🛒 प्रीमियम लेने के लिए /plan पर क्लिक करें और तुरंत एक्सेस पाएं 🚀</b>"
