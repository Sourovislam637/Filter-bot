...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            text = "<b>ʜᴇʏ {username} 👋,\n\nᴀᴀᴘɴᴇ ᴠᴇʀɪғɪᴋᴇꜱʜɴ ᴘᴜʀᴀ ᴋᴀʀ ʟɪʏᴀ ʜᴀɪ ✅\n\nᴀʙ ᴀᴀᴘ ʙᴏᴛ ᴋᴏ 24 ɢʜᴀɴᴛᴇ ᴛᴀᴋ ɪꜱᴛᴇᴍᴀᴀʟ ᴋᴀʀ ꜱᴀᴋᴛᴇ ʜᴀɪɴ — ʙɪɴᴀ ᴋɪꜱɪ ʀᴜᴋᴀᴡᴀᴛ ᴋᴇ 🎬🍿\nᴍᴀᴢᴇ ʟɪᴊɪʏᴇ ꜰᴜʟʟ ꜱᴘᴇᴇᴅ ᴀᴄᴄᴇꜱꜱ ᴋᴇ ꜱᴀᴀᴛʜ 🔥</b>"
            if PREMIUM_AND_REFERAL_MODE == True:
                text += "<b>ᴀɢᴀʀ ᴀᴀᴘ ʙɪɴᴀ ᴋɪꜱɪ ᴠᴇʀɪꜰɪᴋᴇꜱʜɴ ᴋᴇ ᴅɪʀᴇᴄᴛ ꜰɪʟᴇꜱ ᴄᴀʜᴛᴇ ʜᴀɪɴ — ᴛᴏ ʙᴏᴛ ᴋᴀ ꜱᴜʙꜱᴋʀɪᴘꜱʜɴ ʟᴇ ʟᴇɴ ☺️\n\n💶 ʙᴏᴛ ᴋᴀ ꜱᴜʙꜱᴋʀɪᴘꜱʜɴ ᴘʟᴀɴ ʟᴇɴᴇ ᴋᴇ ʟɪʏᴇ /ᴘʟᴀɴ ᴘᴀʀ ᴄʟɪᴄᴋ ᴋᴀʀᴇɴ ʏᴀ ɴɪᴄʜᴇ ᴛʏᴘᴇ ᴋᴀʀᴇɴ — /ᴘʟᴀɴ</b>"           
