...
# Bot information
SESSION = environ.get('SESSION', 'Rare_Anime_Hub')
API_ID = int(environ.get('API_ID', '16160395'))
API_HASH = environ.get('API_HASH', '892a16bf3b1569612b18c9d790967cbb')
BOT_TOKEN = environ.get('BOT_TOKEN', "8151458381:AAGW5nXEvzL5SEYBI4-NeXceZ980bPZY2SY")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6163647625').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002279602417'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002879174745').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002879174745')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://faceyi5878_db_user:tgtTfJHYZnz8uATj@cluster0.nkvuueu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "faceyi5878_db_user")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Rare Anime Hub)
