...
API_ID = int(environ.get('API_ID', '24391598'))
API_HASH = environ.get('API_HASH', '6e93fd3bb6634c133a0d6f2217467d2e')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7573731689').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002842906694'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002881635457').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '1002208739588') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '6425754366')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vishnudivya499:gtKqphk9YHJzuqfD@cluster0.jxgxfih.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/V2LGROUPS')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AUTHCHANNEL499')
SUPPORT_CHAT = environ.get('SUPPORT_CHART','https://t.me/DATABASECHANNEL499') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/V2LGROUPBOT')
