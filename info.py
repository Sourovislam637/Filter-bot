...
auth_channel = environ.get('AUTH_CHANNEL', '-1002085088955') # give your force subscribe channel id here else leave it blank
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies_webseries_anime_download')
